...
source-plane placement was made explicit and the canonical zero-length
auxiliary/metadata placement for direct protected tensors was clarified.
Neither change alters either decision below or qualifies EXL3 GPU load
