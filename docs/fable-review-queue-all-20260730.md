...
parallel and unblock exact checkpoint ingest plus K=4. Items 7 through 12 then
open the coordinated TP4 target/MTP program, checkpoint smoke, and one-layer
replay. Items 13 through 18 independently
...
The decode-benchmark API correction is queued at
...
| 90 | `docs/fable-sm120-rank-executor-v1-r2-handoff.md` | `a0f2bee3edd1754aebefe1643eecd0a63cd4d4b7` | `docs/reviews/fable-sm120-rank-executor-v1-r2.md` | superseded; do not issue `sm120-rank-executor-v1-accepted` |
...
| 124 | `docs/fable-sm120-profiler-package-v1-handoff.md` | `fdbd91647a3ea23031ebd562e3d57676d7eb5d9a` | `fable-sm120-profiler-package-v1.md` | superseded; do not issue `sm120-profiler-package-v1-accepted` |
...
| 129 | `docs/fable-target-layer-execution-v1-r2-handoff.md` | `8a554af72e52bb067bf61edf43735615c6a0942a` | `fable-target-layer-execution-v1-r2.md` | `target-layer-execution-v1-accepted` |
...
| 154 | `docs/fable-distributed-sampling-abi-v1-r2-handoff.md` | `65907bc6d07fd31580637ef0d463c13e678b6783` | `fable-distributed-sampling-abi-v1-r2.md` | `distributed-sampling-abi-v1-r2-design-accepted` |
...
| 160 | `docs/fable-sm120-rank-executor-v1-r4-handoff.md` | `d40333e198c5e61f39ebdb8cbef8721b0b7dcc43` | `docs/reviews/fable-sm120-rank-executor-v1-r4.md` | `sm120-rank-executor-v1-r4-design-accepted` |
